...
import dictionary.crawler.DictionaryDotComCrawler;

import junit.framework.TestCase;

public class RhymeCrawlerTest extends TestCase {

	@Test
	public void testDictionaryDotComRegex() {
		...
		match = t.processPageUrl("syphilis", test);
